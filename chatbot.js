      ...
      <div class="container">
          <div class="chatbox">
              <div class="chatbox__support">
                  <div class="chatbox__header">
                      ...
                      <div class="chatbox__content--header">
                          <h4 class="chatbox__heading--header">Hey, My name is OiMax</h4>
                          <p class="chatbox__description--header"> I am your personal assistant</p>
                      </div>
                  </div>
              ...
              <div class="chatbox__button">
                  <button><img src="https://cdn.jsdelivr.net/gh/optimus-ohya/oimax_chat@latest/frontend/images/oi.png" /></button>
              </div>
          </div>
      </div>
    </div>
